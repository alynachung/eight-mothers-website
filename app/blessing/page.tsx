    ...
    <main className="min-h-screen flex flex-col items-center justify-center font-sans px-6 text-center transition-all duration-1000"
      ...
      {step === 0 && (
        <div className="max-w-2xl mx-auto flex flex-col items-center gap-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 mt-4 w-full justify-center">
            <button 
              onClick={handleDraw}
              className="px-10 py-4 font-medium tracking-widest hover:scale-105 transition-all duration-300"
            ...
            <Link 
              href="/"
              className="px-10 py-4 border font-light tracking-widest hover:bg-white/5 transition-all"
      ...
      {step === 2 && result && (
        <div className="max-w-xl mx-auto flex flex-col items-center gap-8">
          ...
          <p className="text-2xl md:text-3xl font-light tracking-wider">「 {result.text_zh} 」</p>
          <p className="text-base font-light opacity-70 italic px-6">{result.text_en}</p>
